...
const PARTICLE_SEEDS = [
  ...
  { x: 41, y: 23, delay: 0.9, dur: 5.1, size: 3 },
  { x: 95, y: 81, delay: 1.6, dur: 6.0, size: 5 },
  { x: 18, y: 56, delay: 2.3, dur: 3.9, size: 2 },
  { x: 63, y: 38, delay: 0.1, dur: 4.4, size: 4 },
  { x: 29, y: 72, delay: 1.9, dur: 5.6, size: 3 },
  { x: 82, y: 15, delay: 2.6, dur: 3.3, size: 5 },
  { x: 50, y: 85, delay: 0.7, dur: 6.3, size: 2 },
  { x: 37, y: 49, delay: 1.4, dur: 4.8, size: 4 },
];
  ...
  return (
    <div
      style={{
        ...
        background: "linear-gradient(170deg, #0b1929 0%, #0f2744 40%, #132f50 70%, #0b1929 100%)",
        overflow: "hidden",
        direction: "ltr",
      }}
      className={phase === "exiting" ? "brand-loader--exit" : "brand-loader--enter"}
    >
      ...
      >
        ...
        <div className="brand-loader__logo">
          ...
          >
            ...
            {/* Road/Path - Orange dashed - THE STAR of the animation */}
            <path
        ...
        <p className="brand-loader__message">
          جاري التحميل
          <span className="brand-loader__dot-1">.</span>
          <span className="brand-loader__dot-2">.</span>
          <span className="brand-loader__dot-3">.</span>
        </p>
      </div>
    </div>
  );
