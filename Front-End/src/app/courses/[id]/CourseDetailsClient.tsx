...
export default function CourseDetailsClient() {
  ...
  const fetchCourseDetails = async () => {
    try {
      ...
      // تسجيل الكورس في قائمة الكورسات المشاهدة مؤخراً
      addRecentCourse({
        _id: courseData._id,
  ...
  if (isLoading) {
    return (
      <>
        <Header />
        <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 pt-20">
    ...
    <>
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    {course.whatYouWillLearn.map((item, index) => (
                      <div key={index} className="flex items-start gap-3">
                        <FiCheck className="w-5 h-5 text-green-500 dark:text-green-400 shrink-0 mt-0.5" />
                  ...
                  {isEnrolled ? (
                    ...
                    <>
                      ...
                      <div className="flex gap-3">
                        <button
                          ...
                          className="flex-1 bg-linear-to-l from-green-500 to-green-600 text-white py-4 rounded-xl font-bold text-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
                        >
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="w-full bg-linear-to-l from-primary to-primary-dark dark:from-accent dark:to-accent-dark text-white py-4 rounded-xl font-bold text-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
                      >
                  ...
                  <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="flex items-center gap-3">
                      {course.instructor.channelLogo ? (
                        ...
                        <div className="w-12 h-12 rounded-full bg-linear-to-br from-primary to-primary-dark flex items-center justify-center text-white text-xl font-bold">
      ...
      {previewVideo && (
        ...
        >
          ...
          >
            {/* Header */}
            <div className="bg-linear-to-l from-primary to-primary-dark p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
            ...
            <div className="p-4 bg-slate-50 dark:bg-slate-700 flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-linear-to-l from-primary to-primary-dark dark:from-accent dark:to-accent-dark text-white px-6 py-2.5 rounded-xl font-medium hover:shadow-lg transition-all"
              >
